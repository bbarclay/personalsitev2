...
const UmathUexplorerContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">UmathUexplorer</h2>
        <p>Interactive UmathUexplorer visualization and calculation tool.</p>
      </div>
      <MainComponent />
    </div>
  ),
...
export default function UmathUexplorerPage() {
  return (
    <ToolPageLayout meta={meta}>
      <UmathUexplorerContent />
    </ToolPageLayout>
  );
}
