...
const CollatzAnalysisContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">CollatzAnalysis</h2>
      </div>
...
export default function CollatzAnalysisPage() {
  return (
    <ToolPageLayout meta={meta}>
      <CollatzAnalysisContent />
    </ToolPageLayout>
  );
}
