...
const UprimeUspiralContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">UprimeUspiral</h2>
        <p>Interactive UprimeUspiral visualization and calculation tool.</p>
      </div>
      <MainComponent />
    </div>
  ),
...
export default function UprimeUspiralPage() {
  return (
    <ToolPageLayout meta={meta}>
      <UprimeUspiralContent />
    </ToolPageLayout>
  );
}
