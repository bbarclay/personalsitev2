...
const LMatrix_LCompletionContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">LMatrix_LCompletion</h2>
        <p>Interactive LMatrix LCompletion visualization and calculation tool.</p>
      </div>
      <IndexComponent />
    </div>
  ),
...
export default function LMatrix_LCompletionPage() {
  return (
    <ToolPageLayout meta={meta}>
      <LMatrix_LCompletionContent />
    </ToolPageLayout>
  );
}
