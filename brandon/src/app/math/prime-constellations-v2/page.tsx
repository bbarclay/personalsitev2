...
const UprimeUconstellationsUv2Content = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">UprimeUconstellationsUv2</h2>
        <p>Interactive UprimeUconstellationsUv2 visualization and calculation tool.</p>
      </div>
      <MainComponent />
    </div>
  ),
...
export default function UprimeUconstellationsUv2Page() {
  return (
    <ToolPageLayout meta={meta}>
      <UprimeUconstellationsUv2Content />
    </ToolPageLayout>
  );
}
