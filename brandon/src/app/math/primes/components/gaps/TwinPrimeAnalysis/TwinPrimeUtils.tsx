...
export const isTwinPrime = (prime1, prime2) => {
...
// Analyze twin primes
type AnalysisResult = [number, number, number | null, number | null, string];

export function analyzeTwinPrimes(twinPrimes: number[][]) {
