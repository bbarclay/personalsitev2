  ...
  return (
    <div className="space-y-6 p-4">
      ...
      <div className="text-lg bg-blue-50 p-4 rounded-lg">
        The Erdős discrepancy problem is about finding patterns in sequences of +1s and -1s.
        Let&apos;s skip count through the sequence and see what happens to the sum!
      </div>
        ...
        {sequence.map((value, index) => (
          <div
            ...
            className={`
              ...
              ${highlighted.includes(index) ? 'ring-2 ring-blue-500 transform scale-110' : ''}
      ...
      {highlighted.length > 0 && (
        <div className="text-xl bg-green-50 p-4 rounded-lg">
          When we skip count by <strong>{stepSize}</strong>,
          the sum is <strong>{runningSum}</strong>
          {Math.abs(runningSum) > 2 &&
      ...
      <div className="bg-gray-50 p-4 rounded-lg space-y-2">
        ...
        <ul className="list-disc list-inside space-y-1">
          ...
          <li>We&apos;re &quot;skip counting&quot; through it (like counting by 2s or 3s)</li>
          <li>We add up all the numbers we land on</li>
          <li>Erdős proved that no matter what sequence you choose,
            you can always find a way to skip count that makes this sum really big!</li>
        </ul>
      </div>
    </div>
  );
