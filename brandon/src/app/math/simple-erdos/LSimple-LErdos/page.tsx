...
const LSimple_LErdosContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">LSimple_LErdos</h2>
        <p>Interactive LSimple LErdos visualization and calculation tool.</p>
      </div>
      <IndexComponent />
    </div>
  ),
...
export default function LSimple_LErdosPage() {
  return (
    <ToolPageLayout meta={meta}>
      <LSimple_LErdosContent />
    </ToolPageLayout>
  );
}
