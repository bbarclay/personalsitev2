...
const UprimeUobservatoryContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">UprimeUobservatory</h2>
        <p>Interactive UprimeUobservatory visualization and calculation tool.</p>
      </div>
      <IndexComponent />
    </div>
  ),
...
export default function UprimeUobservatoryPage() {
  return (
    <ToolPageLayout meta={meta}>
      <UprimeUobservatoryContent />
    </ToolPageLayout>
  );
}
