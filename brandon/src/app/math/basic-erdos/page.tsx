...
const UbasicUerdosContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">UbasicUerdos</h2>
        <p>Interactive UbasicUerdos visualization and calculation tool.</p>
      </div>
      <MainComponent />
    </div>
  ),
...
export default function UbasicUerdosPage() {
  return (
