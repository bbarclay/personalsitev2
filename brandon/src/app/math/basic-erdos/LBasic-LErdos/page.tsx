...
const LBasic_LErdosContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">LBasic_LErdos</h2>
        <p>Interactive LBasic LErdos visualization and calculation tool.</p>
      </div>
      <IndexComponent />
    </div>
  ),
...
export default function LBasic_LErdosPage() {
  return (
    <ToolPageLayout meta={meta}>
      <LBasic_LErdosContent />
    </ToolPageLayout>
  );
}
