...
const LSymbol_LIconContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">LSymbol_LIcon</h2>
        <p>Interactive LSymbol LIcon visualization and calculation tool.</p>
      </div>
      <IndexComponent />
    </div>
  ),
...
export default function LSymbol_LIconPage() {
  return (
    <ToolPageLayout meta={meta}>
      <LSymbol_LIconContent />
    </ToolPageLayout>
  );
}
