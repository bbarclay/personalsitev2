...
const UpythagoreanUexplorerContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">UpythagoreanUexplorer</h2>
        <p>Interactive UpythagoreanUexplorer visualization and calculation tool.</p>
      </div>
      <MainComponent />
    </div>
  ),
...
export default function UpythagoreanUexplorerPage() {
  return (
    <ToolPageLayout meta={meta}>
      <UpythagoreanUexplorerContent />
    </ToolPageLayout>
  );
}
