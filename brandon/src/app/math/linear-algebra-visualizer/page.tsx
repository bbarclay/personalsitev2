...
const LinearAlgebraVisualizerContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">LinearAlgebraVisualizer</h2>
      </div>
...
export default function LinearAlgebraVisualizerPage() {
  return (
    <ToolPageLayout meta={meta}>
      <LinearAlgebraVisualizerContent />
    </ToolPageLayout>
  );
}
