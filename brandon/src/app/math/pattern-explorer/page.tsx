...
const LPattern_LExplorerContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">LPattern_LExplorer</h2>
        <p>Interactive LPattern LExplorer visualization and calculation tool.</p>
      </div>
      <IndexComponent />
    </div>
  ),
...
export default function LPattern_LExplorerPage() {
  return (
    <ToolPageLayout meta={meta}>
      <LPattern_LExplorerContent />
    </ToolPageLayout>
  );
}
