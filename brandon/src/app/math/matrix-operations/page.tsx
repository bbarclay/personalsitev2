...
const UmatrixUoperationsContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">UmatrixUoperations</h2>
        <p>Interactive UmatrixUoperations visualization and calculation tool.</p>
      </div>
      <IndexComponent />
    </div>
  ),
...
export default function UmatrixUoperationsPage() {
  return (
    <ToolPageLayout meta={meta}>
      <UmatrixUoperationsContent />
    </ToolPageLayout>
  );
}
