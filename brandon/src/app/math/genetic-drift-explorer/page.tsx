...
const LGenetic_LDrift_LExplorerContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">LGenetic_LDrift_LExplorer</h2>
        <p>Interactive LGenetic LDrift LExplorer visualization and calculation tool.</p>
      </div>
      <IndexComponent />
    </div>
  ),
...
export default function LGenetic_LDrift_LExplorerPage() {
  return (
    <ToolPageLayout meta={meta}>
      <LGenetic_LDrift_LExplorerContent />
    </ToolPageLayout>
  );
}
