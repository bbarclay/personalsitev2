...
const LSlot_LMachine_LHeaderContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">LSlot_LMachine_LHeader</h2>
        <p>Interactive LSlot LMachine LHeader visualization and calculation tool.</p>
      </div>
      <IndexComponent />
    </div>
  ),
...
export default function LSlot_LMachine_LHeaderPage() {
  return (
    <ToolPageLayout meta={meta}>
      <LSlot_LMachine_LHeaderContent />
    </ToolPageLayout>
  );
}
