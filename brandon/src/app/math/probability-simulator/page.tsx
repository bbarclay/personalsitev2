...
const UprobabilityUsimulatorContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">UprobabilityUsimulator</h2>
        <p>Interactive UprobabilityUsimulator visualization and calculation tool.</p>
      </div>
      <IndexComponent />
    </div>
  ),
...
export default function UprobabilityUsimulatorPage() {
  return (
    <ToolPageLayout meta={meta}>
      <UprobabilityUsimulatorContent />
    </ToolPageLayout>
  );
}
