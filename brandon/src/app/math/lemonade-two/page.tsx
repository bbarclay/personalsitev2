...
const UlemonadeUtwoContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">UlemonadeUtwo</h2>
        <p>Interactive UlemonadeUtwo visualization and calculation tool.</p>
      </div>
      <IndexComponent />
    </div>
  ),
...
export default function UlemonadeUtwoPage() {
  return (
    <ToolPageLayout meta={meta}>
      <UlemonadeUtwoContent />
    </ToolPageLayout>
  );
}
