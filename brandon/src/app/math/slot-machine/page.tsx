...
const UslotUmachineContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">UslotUmachine</h2>
      </div>
...
export default function UslotUmachinePage() {
  return (
    <ToolPageLayout meta={meta}>
      <UslotUmachineContent />
    </ToolPageLayout>
  );
}
