...
const UgeometryUvisualizerContent = createDynamicPanelComponent({
  solver: () => (
    <div className="space-y-6">
      <div className="prose dark:prose-invert max-w-none">
        <h2 className="text-2xl font-bold">UgeometryUvisualizer</h2>
        <p>Interactive UgeometryUvisualizer visualization and calculation tool.</p>
      </div>
      <IndexComponent />
    </div>
  ),
...
export default function UgeometryUvisualizerPage() {
  return (
    <ToolPageLayout meta={meta}>
      <UgeometryUvisualizerContent />
    </ToolPageLayout>
  );
}
